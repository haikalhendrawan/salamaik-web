...
import {Stack, Button, Tabs, Tab, Table, Card, IconButton, TableSortLabel,
...
const TABLE_DATA = [
  {id:1, subsubkomponen:'KPPN menyelenggarakan', subkomponen:'Pengelolaan Anggaran dan kebijaan yang aktual bagi pemeringah stempat dan perangkat', komponen:'Treasurer', numChecklist:10, action:'edit'},
  {id:2, subsubkomponen:'ada opsi KPPN', subkomponen:'Pengelolaan APBD', komponen:'Pengelola Fiskal, Representasi Kemenkeu di Daerah, dan Special Mission', numChecklist:34, action:'edit'},
  {id:3, subsubkomponen:'Digipay', subkomponen:'TURT', komponen:'Financial Advisor', numChecklist:5, action:'edit'},
  {id:4, subsubkomponen:'anggaran sudah terkelola di KPPN dengan mekanisme', subkomponen:'Pengelolaan SDM', komponen:'Tata Kelola Internal', numChecklist:17, action:'edit'},
];
...
//------------------------------------------------------------------------------------
export default function SubSubKomponenRef({changeSection}: SubSubKomponenRefProps) {
