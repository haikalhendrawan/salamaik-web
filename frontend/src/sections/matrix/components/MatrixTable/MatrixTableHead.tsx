...
const TABLE_HEAD = [
  ...
  { id: 'hasil', label: 'Hasil Implementasi di Lapangan', alignRight: false, width: '15%' },
  ...
  { id: 'pic', label: 'PIC Subbag/Seksi', alignRight: false, width: '5%' },
  { id: 'tindakLanjut', label: 'Tindak lanjut Atas Permasalahan', alignRight: false, width: '15%' },
  { id: 'statusTL', label: 'Status Penyelesaian Tindak Lanjut', alignRight: false , width: '5%'},
