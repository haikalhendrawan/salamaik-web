...
router.get('/getFindingsByWorksheetId/:kppnId', authenticate, authorize([99, 4]), findingsController.getFindingsByWorksheetId);
...
router.post('/updateFindingStatus', authenticate, authorize([99, 4]), findingsController.updateFindingStatus);
