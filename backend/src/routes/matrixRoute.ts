...
router.post('/updateMatrix', authenticate, authorize([99, 4, 2]), matrixController.updateMatrix);
router.post('/reAssignMatrix', authenticate, authorize([99, 4]), matrixController.reAssignMatrix);
